...
- [`codebuff/base`](/publishers/codebuff/agents/base) - Main coding assistant
- [`codebuff/reviewer`](/publishers/codebuff/agents/reviewer) - Code review agent
- [`codebuff/thinker`](/publishers/codebuff/agents/thinker) - Deep thinking agent
- [`codebuff/researcher`](/publishers/codebuff/agents/researcher) - Research and documentation agent
- [`codebuff/planner`](/publishers/codebuff/agents/planner) - Planning and architecture agent
- [`codebuff/file-picker`](/publishers/codebuff/agents/file-picker) - File discovery agent
