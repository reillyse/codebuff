...
This example uses [`reviewer`](/publishers/codebuff/agents/reviewer), [`researcher`](/publishers/codebuff/agents/researcher), and [`file-picker`](/publishers/codebuff/agents/file-picker) as spawnable subagents:
